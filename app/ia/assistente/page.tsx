...
export default function AssistentePage() {
  return (
    <ConceptPage
      breadcrumb={[{ label: "Inteligência Artificial", href: "/ia" }, { label: "Assistente DAVI" }]}
      eyebrow="Assistente DAVI"
      ...
      sections={[
        {
          ...
          paragraphs: [
            "O Assistente DAVI poderá responder perguntas sobre os módulos, explicar como começar e orientar o uso do DAVI Vision, DAVI Conecta, DAVI Escola, comunicação alternativa, BioSinal, catálogo, oficina maker e relatórios.",
