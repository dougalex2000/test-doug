...
/**
 * Mega-menu por jornada de uso (estilo gov.br: categorias + links).
 * Reaproveita rotas existentes; não cria páginas novas.
 */
export type MegaCategoria = { titulo: string; descricao: string; itens: NavItem[] };

export const megaMenu: MegaCategoria[] = [
  {
    titulo: "Início",
    descricao: "Conhecer o projeto e a plataforma.",
    itens: [
      { label: "Página inicial", href: "/" },
      { label: "Sobre o Projeto DAVI", href: "/projeto" },
      { label: "Recursos do DAVI", href: "/#recursos" },
      { label: "Manual da Plataforma", href: "/manual" },
      { label: "Ecossistema DAVI", href: "/projeto/ecossistema" },
    ],
  },
  {
    titulo: "Comunicação e Acesso",
    descricao: "Formas de se comunicar e interagir com a plataforma.",
    itens: [
  ...
  {
    titulo: "Aprendizagem",
    descricao: "Conteúdos e atividades pedagógicas acessíveis.",
    itens: [
  ...
  },
  {
    ...
    descricao: "Apoio inteligente, métricas e evolução.",
    itens: [
      ...
      { label: "Histórico de atividades", href: "/evolucao/linha-do-tempo" },
    ],
  },
  {
    titulo: "Tecnologia Assistiva e Oficina",
    descricao: "Catálogo, fabricação e dispositivos.",
    itens: [
