...
export const metadata: Metadata = {
  ...
  description:
    "O celular como dispositivo de tecnologia assistiva para comunicação, aprendizagem e autonomia.",
};

const functions: ModuleCard[] = [
  {
    title: "Botão Sim e Não",
    description:
      "Respostas rápidas com botões grandes para Sim, Não, Talvez, Não sei, Ajuda e Terminar.",
    icon: <IconSwitchButton className="h-6 w-6" />,
  },
  {
    title: "Prancha de comunicação",
    description:
      "Frases, palavras, pictogramas e botões personalizados, com possibilidade futura de fala por síntese de voz.",
    icon: <IconChat className="h-6 w-6" />,
  },
  {
    title: "Escrita com o dedo",
    description:
      "Treino de letras, sílabas, palavras, números e frases, incluindo letra bastão e cursiva.",
    icon: <IconDocument className="h-6 w-6" />,
  },
  {
    title: "Joystick para jogos",
    description:
      "Direcional, botões de ação e comandos adaptados para controlar jogos educativos.",
    icon: <IconJoystick className="h-6 w-6" />,
  },
  {
    title: "Mouse alternativo",
    description:
      "Touchpad, clique, duplo clique, arrastar e rolagem para navegar pela plataforma.",
    icon: <IconTouch className="h-6 w-6" />,
  },
  {
    title: "Teclado adaptado",
    description:
      "Letras grandes, sílabas, números, palavras frequentes e frases prontas em uma interface simples.",
    icon: <IconCheckCircle className="h-6 w-6" />,
  },
  {
    title: "Controle de videoaulas",
    description:
      "Play, pause, repetir, avançar, voltar, próxima aula, terminar exercício e pedir ajuda.",
    icon: <IconGamepad className="h-6 w-6" />,
  },
  {
    title: "Acionador por movimento",
    description:
      "Movimento, inclinação, giro ou chacoalhar podem se tornar comandos configuráveis.",
    icon: <IconLightbulb className="h-6 w-6" />,
  },
  {
    title: "Interação por câmera",
    description:
      "Estudo futuro de gestos, movimento da cabeça, passagem da mão e piscadas como formas de interação.",
    icon: <IconEye className="h-6 w-6" />,
  },
  {
    title: "Ponte com dispositivos físicos",
    description:
      "Conexão futura com equipamentos embarcados, sensores, botões adaptados e módulos eletrônicos assistivos.",
...
export default function DaviCelAcessoPage() {
  return (
    <PageShell>
      <Breadcrumb
        items={[
          { label: "Acesso e Dispositivos", href: "/acesso" },
          { label: "DAVI CelAcesso" },
        ]}
      />
      <PageHero
        eyebrow="DAVI CelAcesso"
        title="DAVI CelAcesso"
        description="O celular como dispositivo de tecnologia assistiva para comunicação, aprendizagem e autonomia. Uma interface multifuncional conectada à plataforma DAVI."
        actions={
          <>
      ...
      <section className="border-b border-zinc-200 bg-white px-6 py-16">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <SectionHeader
            ...
            title="Uma porta de acesso que já está no cotidiano"
            description="Muitas famílias e instituições ainda não possuem botões adaptados, joysticks, mouses especiais ou pranchas eletrônicas. O CelAcesso aproveita um recurso mais presente: o celular."
          />
          <div className="space-y-4 text-lg leading-8 text-zinc-700">
            <p>
              O DAVI CelAcesso nasce para transformar o celular em uma porta de
              acesso à comunicação, à aprendizagem e à participação digital.
            </p>
            <p>
              Em vez de depender inicialmente de equipamentos especializados, o
              smartphone pode funcionar como entrada, controle e interface de
              interação em casa, na escola, em instituições e em salas de recursos.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-zinc-200 bg-white px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="A plataforma pode ser aberta em uma TV, computador, notebook ou tablet, enquanto o CelAcesso funciona como controle assistivo conectado à mesma sessão."
          />
          <div className="mt-8">
      ...
      <section className="border-b border-zinc-200 bg-[#F6F8FB] px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            ...
            description="O CelAcesso combina métodos de entrada com conteúdos, atividades e acompanhamento."
          />
          <div className="mt-10">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-4 max-w-3xl text-lg leading-8 text-zinc-700">
                O DAVI CelAcesso parte de um recurso presente em muitas famílias para
